...
NHTSA. The Clean Air Act7 gives EPA general authority to establish emissions limits for new motor vehicles for air pollutants that are found to pose a danger to
...
Seek to refocus the FHWA on maintaining and improving the
highway system.
Remove or reform rules and regulations that hamper state
governments.
Reduce the amount of federal involvement in local
