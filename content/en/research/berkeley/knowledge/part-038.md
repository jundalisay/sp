...
155. Fourthly, It will be objected that from the foregoing Principles it follows, Things
...
then I give up the Cause: But if he cannot, he will acknowledge it is unreasonable for him to stand up in defence of he knows not what, and pretend to charge on me as an Absurdity, the not assenting to those Propositions which at Bottom have no meaning in them.

156. It will not be amiss to observe, how far the received Principles of Philosophy are
...
The Reason therefore, that any particular Body
...
those perceived by an obtuser Sense. 


And at length, after various Changes of Size and Shape,
...
charged on the Principles we have premised, so as in truth to make any Objection at all against our Notions. For though we hold indeed the Objects of Sense to be nothing else but Ideas
...
those Colours are on all hands acknowledged to exist in it, and no where else. 
...
In short, whatever Advances have been made, either by ancient or modern
