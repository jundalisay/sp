...
Beauty accompanied with grace is the principal object of sculpture, it loves nakedness, and allows clothing only
...
scenes, events, and actions. This is the endless problem of the historical painter, and he solves it by placing before us scenes of
...
it reveals, in that it brings to light sides of that Idea which[298]
...
beer-house over cards and dice, just as it is all the same whether we play chess with golden or wooden pieces. But apart from this,
...
should take place behind the scenes (as in French tragedies), it[300]
...
to have recourse to miserable beings of every kind. 

For the
New Testament, as regards its historical part, is almost more unsuitable for painting than the Old, and the subsequent history
...
own nature.56
56 In order to understand this passage it is necessary to have read the whole of
