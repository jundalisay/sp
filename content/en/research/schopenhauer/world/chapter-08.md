...
The light of the moon is from the sun.

Similarly, we pass from the immediate idea of perception, which stands by itself, to reflection, to the abstract, discursive concepts of the reason, which obtain their whole content from knowledge of perception, and in relation to
it. As long as we continue simply to perceive, all is clear, firm,
and certain. 

There are neither questions nor doubts nor errors;
...
does not present an opinion but the thing itself. 
...
expressed by the same word; A ªø≥ø¬, il discorso. Vernunft is
...
A ªø≥ø¬, ƒø ªø≥π√ƒπ∫øΩ, ƒø ªø≥πºøΩ, ratio. Besides this, no
...
of the want of reason, we must never expect even from the most sensible brute. The philosophers of all ages may be said to [049]
