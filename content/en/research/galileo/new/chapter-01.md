...
Mechanics is based on geometry, where mere size cuts no shape. I do not see that the properties of circles, triangles, cylinders, cones and other solid figures will change with their size.

If, therefore, a large machine has its parts at the same ratio as in a smaller one, and if the smaller is strong for its purpose, I do not see why the larger also should not withstand any severe tests. 
{{< /r >}}
...
Imperfections in the material, even those which are great enough to invalidate the clearest mathematical proof, are not sufficient to explain the deviations observed between machines in the concrete and in the abstract.  
...
I assume matter to be unchangeable and always the same. So we are no less able to treat this constant and invariable property in a rigid manner than if it belonged to simple and pure mathematics.
...
For we can demonstrate by geometry that the large machine is not proportionately stronger than the small.

For every machine and structure, whether artificial or natural, there is set a necessary limit beyond which neither art nor nature can pass; it is here understood, of course, that the material is the same and the proportion preserved. 
{{< /l >}}


{{< r a="Sagredo" >}}
I think it is impossible to build 2 similar structures of the same material, but of different sizes and have them proportionately strong.

If this were so, it would [52] not be possible to find two single poles made of the same wood which shall be alike in strength and resistance but unlike in size.
{{< /r >}}
