...
How one can reduce the number of dimensions of an equation when one knows one of its roots. 

How one can examine whether a given quantity is the value of a root
