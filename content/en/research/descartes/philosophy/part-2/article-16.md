...
{{< n n="This is because our minds are able to impose a length, width and depth to empty space, but not to a Void" >}}
...
<!-- And if, instead of remembering what we should mean by “void” or “nothing,” we later think that a space where our senses detect nothing contains no created thing, we would be making a mistake as obvious as imagining that a jug containing only air holds nothing at all,  -->
...
<!-- Nearly all of us have been influenced by this mistaken idea from the very beginning of our lives—namely, that since  -->
...
<!-- - Extension cannot exist without something extended. -->
